...
- **2026-04-19**: 初版。TK2LAB と Codex で 2026-04-18 に実施した検証を
  反映し、公開リポジトリの MAINTAINER-NOTES として配置。
- **今後の更新**: Codex レビュー応答を反映したタイミングで、各表の
  「Codex レビューメモ」列を埋めつつ、状態確定項目に「確認済み」
  タグを付け、未確定項目は次回宿題に繰り越す。
